...
This repository contains the main files and reports from the (code related) courses I took during my Bachelor's degree. 
The courses can further be sorted listed by year:

**1st year subjects:**
* TDAT1001 - Introduction to programming 
* TDAT1003 - Computer architecture and operating systems (not represented)
* TDAT1004 - Mathematics 1 (not represented)
...
**2nd year subjects:**
* TDAT2001 - Natural sciences and statistics (not represented)
