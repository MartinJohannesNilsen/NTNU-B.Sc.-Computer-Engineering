...
def OurModel(input_shape, action_space):
    ...
    # Use ReLu as an activation functiom
...
class DQNAgent:
    def __init__(self):
        ...
        self.epsilon = 1.0  # exploration rate, start high for full exploration
        self.epsilon_min = 0.001  # minimum exploration rate
        # What we multiply epsilon with each time for lowering exploration
    ...
    def remember(self, state, action, reward, next_state, done):
        # Memory buffer in a deque, remember actions
